...
public abstract class Database
{
    ...
    public static async Task Execute(string sqlCommand, Dictionary<string, object>? commandParams = null, CancellationToken cancellationToken = default)
    {
        await Db.Execute(sqlCommand, commandParams, cancellationToken: cancellationToken);
    }
    
    public static async Task<T?> Query<T>(string sqlCommand, Dictionary<string, object>? queryParams = null, CancellationToken cancellationToken = default)
    {
